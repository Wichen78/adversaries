...
public class PersonData {
    ...
    private static final double FIRST_GUARD_DEFENSE = 0.25;

    private static final double SECOND_GUARD_DEFENSE_1 = 0.4;
    private static final double SECOND_GUARD_DEFENSE_2 = 0.5; // Vicious Mummy

    private static final double FEARED_ADV_DEFENSE_1 = 0.4; // Peter Pettigrew
    private static final double FEARED_ADV_DEFENSE_2 = 0.5;
    private static final double FEARED_ADV_DEFENSE_3 = 0.7; // Ancient Ukranian Ironbelly

    // DEFENSE BREACH

    private static final double FIRST_GUARD_DEFENSE_BREACH_1 = 0.2;
    private static final double FIRST_GUARD_DEFENSE_BREACH_2 = 0.25; // Common Troll, Formidable Acromantula

    private static final double SECOND_GUARD_DEFENSE_BREACH_1 = 0.2;
    private static final double SECOND_GUARD_DEFENSE_BREACH_2 = 0.25;
    private static final double SECOND_GUARD_DEFENSE_BREACH_3 = 0.3; // Three Headed Dog

    private static final double FEARED_ADV_DEFENSE_BREACH_1 = 0.2;
    private static final double FEARED_ADV_DEFENSE_BREACH_2 = 0.25; // Fenrir Greyback
    private static final double FEARED_ADV_DEFENSE_BREACH_3 = 0.4; // Ancient Hungarian Horntail
    private static final double FEARED_ADV_DEFENSE_BREACH_4 = 0.5; // Ancient Norwegian Ridgeback

    // PROFICIENCY

    private static final double FIRST_GUARD_PROFICIENCY_1 = 0.5;
    private static final double FIRST_GUARD_PROFICIENCY_2 = 0.505; // Common Serpent

    private static final double SECOND_GUARD_PROFICIENCY = 0.5;

    // DEFICIENCY

    private static final double FIRST_GUARD_DEFICIENCY_1 = 0.75;
    private static final double FIRST_GUARD_DEFICIENCY_2 = 0.76;

    private static final double SECOND_GUARD_DEFICIENCY_1 = 0.75;
    private static final double SECOND_GUARD_DEFICIENCY_2 = 0.76;

    // ACCURACY

    private static final double FEARED_ACCURACY = 0.2;
    ...
    public static Person createCommonSerpent_DracoMalforLineup() {
        return builder("common serpent", 188, 16,
                FIRST_GUARD_PROFICIENCY_2, FIRST_GUARD_DEFICIENCY_1,
                FIRST_GUARD_DEFENSE, FIRST_GUARD_DEFENSE_BREACH_1,
                FEARED_ACCURACY, 0,
    ...
    public static Person createImposingDarkWizard_DracoMalforLineup() {
        return builder("imposing dark wizard", 763, 49,
                SECOND_GUARD_PROFICIENCY, SECOND_GUARD_DEFICIENCY_2,
                SECOND_GUARD_DEFENSE_1, SECOND_GUARD_DEFENSE_BREACH_2,
                FEARED_ACCURACY, 0,
    ...
    public static Person createDracoMalfoy_DracoMalforLineup() {
        return builder("draco malfoy", 1635, 80,
                0, 0,
                FEARED_ADV_DEFENSE_2, FEARED_ADV_DEFENSE_BREACH_1,
                FEARED_ACCURACY, 0,
    ...
    public static Person createImposingSnatcher_FenrirGreybackLineup() {
        return builder("imposing snatcher", 206, 18,
                FIRST_GUARD_PROFICIENCY_1, FIRST_GUARD_DEFICIENCY_1,
                FIRST_GUARD_DEFENSE, FIRST_GUARD_DEFENSE_BREACH_1,
                FEARED_ACCURACY, 0,
    ...
    public static Person createDangerousWerewolf_FenrirGreybackLineup() {
        return builder("dangerous werewolf", 802, 51,
                SECOND_GUARD_PROFICIENCY, SECOND_GUARD_DEFICIENCY_2,
                SECOND_GUARD_DEFENSE_1, SECOND_GUARD_DEFENSE_BREACH_1,
                FEARED_ACCURACY, 0,
    ...
    public static Person createFenrirGreyback_FenrirGreybackLineup() {
        return builder("fenrir greyback", 1693, 83,
                0, 0,
                FEARED_ADV_DEFENSE_2, FEARED_ADV_DEFENSE_BREACH_2,
                FEARED_ACCURACY, 0,
                Profession.NONE, Set.of(Species.FEARED_ADV, Species.DARK_WIZARD));
    }
    ...
    public static Person createFormidableSerpent_SlytherinsBasiliskLineup() {
        return builder("formidable serpent", 486, 30,
                FIRST_GUARD_PROFICIENCY_1, FIRST_GUARD_DEFICIENCY_1,
                FIRST_GUARD_DEFENSE, FIRST_GUARD_DEFENSE_BREACH_1,
                FEARED_ACCURACY, 0, Profession.BEASTS,
    ...
    public static Person createCommonAcromantula_AragogLineup() {
        return builder("common acromantula", 522, 30,
                FIRST_GUARD_PROFICIENCY_1, FIRST_GUARD_DEFICIENCY_2,
                FIRST_GUARD_DEFENSE, FIRST_GUARD_DEFENSE_BREACH_1,
                FEARED_ACCURACY, 0,
                Profession.BEASTS, Set.of(Species.ACROMANTULA, Species.FEARED_ADV));
    }
    ...
    public static Person createPeterPettigrew_PeterPettigrewLineup() {
        return builder("peter pettigrew", 2565, 122,
                0, 0,
                FEARED_ADV_DEFENSE_1, FEARED_ADV_DEFENSE_BREACH_1,
                FEARED_ACCURACY, 0,
                Profession.NONE, Set.of(Species.FEARED_ADV, Species.DARK_WIZARD));
    }
    ...
    public static Person createCommonTroll_AncientNorwegianRidgebackLineup() {
        return builder("common troll", 807, 41,
                FIRST_GUARD_PROFICIENCY_1, FIRST_GUARD_DEFICIENCY_1,
                FIRST_GUARD_DEFENSE, FIRST_GUARD_DEFENSE_BREACH_2,
                FEARED_ACCURACY, 0,
    ...
    public static Person createThreeHeadedDog_AncientNorwegianRidgebackLineup() {
        return builder("three-headed dog", 1576, 73,
                SECOND_GUARD_PROFICIENCY, SECOND_GUARD_DEFICIENCY_2,
                SECOND_GUARD_DEFENSE_1, SECOND_GUARD_DEFENSE_BREACH_3,
                FEARED_ACCURACY, 0,
    ...
    public static Person createAncientNorwegianRidgeback_AncientNorwegianRidgebackLineup() {
        return builder("ancient norwegian ridgeback", 2587, 122,
                0, 0,
                FEARED_ADV_DEFENSE_2, FEARED_ADV_DEFENSE_BREACH_4,
                FEARED_ACCURACY, 0,
                Profession.NONE, Set.of(Species.FEARED_ADV, Species.DARK_WIZARD));
    }
    ...
    public static Person createViciousMummy_AncientUkranianIronbellyLineup() {
        return builder("vicious mummy", 1641, 76,
                SECOND_GUARD_PROFICIENCY, SECOND_GUARD_DEFICIENCY_1,
                SECOND_GUARD_DEFENSE_2, SECOND_GUARD_DEFENSE_BREACH_1,
                FEARED_ACCURACY, 0,
    ...
    public static Person createAncientUkranianIronbelly_AncientUkranianIronbellyLineup() {
        return builder("ancient ukranian ironbelly", 2606, 122,
                0, 0,
                FEARED_ADV_DEFENSE_3, FEARED_ADV_DEFENSE_BREACH_1,
                FEARED_ACCURACY, 0,
                Profession.NONE, Set.of(Species.FEARED_ADV, Species.DARK_WIZARD));
    }
    ...
    public static Person createAncientHungarianHorntail_AncientHungarianHorntailLineup() {
        return builder("ancient hungarian horntail", 2625, 122,
                0, 0,
                FEARED_ADV_DEFENSE_2, FEARED_ADV_DEFENSE_BREACH_3,
                FEARED_ACCURACY, 0,
                Profession.NONE, Set.of(Species.FEARED_ADV));
    }
